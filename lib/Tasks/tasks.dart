...
class Tasks extends StatelessWidget {
  ...
  List <Task> currentTasks = [
    Task(title: 'first task', status: 'ongoing', deadline: DateTime.now(), membersList: [], assignedProject: 'first project', startDate: DateTime.now(), taskDescription: 'This is the first task in this page')
  ];
